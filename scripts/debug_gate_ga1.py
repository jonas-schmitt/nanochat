...
def main():
    ...
    # --- side A: the reference harness's run_arm (muon arm) ---
    ...
    tcp.run_arm("muon", args.matrix_lr, args, model_a, train, val, device)
    ...
    td.run_policy(dp_genome(), args, model_b, [train], val, device)
